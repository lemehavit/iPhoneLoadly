...
```bash
sudo sha256sum -c iphoneloadly-v0.2.0-alpha.3-linux-amd64.tar.gz.sha256
tar -xzf iphoneloadly-v0.2.0-alpha.3-linux-amd64.tar.gz
cd iphoneloadly-v0.2.0-alpha.3-linux-amd64
